...
import io.nekohasekai.sagernet.database.ConfigLock
...
class ConfigurationFragment @JvmOverloads constructor(
            ...
            if (file != null) runOnDefaultDispatcher {
                try {
                    ...
                    if (fileName != null && fileName.endsWith(".zip")) {
                        ...
                        if (ManagedConfig.isManagedConfig(fileText)) {
                            (requireActivity() as MainActivity).importManagedConfig(fileText)
    ...
    private fun isLockedProfileWriteAction(itemId: Int): Boolean {
        ...
        return when (itemId) {
            ...
            R.id.action_remove_duplicate -> true
    ...
    override fun onMenuItemClick(item: MenuItem): Boolean {
        if (isLockedProfileWriteAction(item.itemId)) {
        ...
        when (item.itemId) {
            ...
            R.id.action_import_clipboard -> {
                ...
                if (text.isBlank()) {
                    ...
                    try {
                        if (ManagedConfig.isManagedConfig(text)) {
                            (requireActivity() as MainActivity).importManagedConfig(text)
                            return@runOnDefaultDispatcher
                        }
    ...
    class GroupFragment : Fragment() {
            ...
            if (!select) {
                ...
                ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(
                    ...
                    override fun getDragDirs(
                        recyclerView: RecyclerView,
                        viewHolder: RecyclerView.ViewHolder,
                    ) = if (isEnabled && !BuildConfig.CUSTOM_LOCKED_APP) {
        ...
        inner class ConfigurationHolder(val view: View) : RecyclerView.ViewHolder(view),
            ...
            fun bind(proxyEntity: ProxyEntity, trafficData: TrafficData? = null) {
                ...
                entity = proxyEntity
                val profileLocked = ConfigLock.isProfileLocked(proxyEntity.id)
                ...
                editButton.setOnClickListener {
                    if (profileLocked) return@setOnClickListener
                ...
                runOnDefaultDispatcher {
                    ...
                    onMainDispatcher {
                        editButton.isEnabled = !started && !profileLocked
            ...
            override fun onMenuItemClick(item: MenuItem): Boolean {
                try {
                    ...
                    when (item.itemId) {
                        ...
                        R.id.action_managed_config_locked_clipboard -> {
                            export(ManagedConfig.exportProfiles(listOf(entity), true))
                        }

                        R.id.action_managed_config_unlocked_clipboard -> {
                            export(ManagedConfig.exportProfiles(listOf(entity), false))
                        }
                    }
                } catch (e: Exception) {
                    Logs.w(e)
